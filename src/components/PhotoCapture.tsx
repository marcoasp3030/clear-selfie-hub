      ...
      <div className="relative flex-1 overflow-hidden">
        ...
        {!showReview && countdown === null && (
          <button
            ...
            className="absolute bottom-24 left-1/2 -translate-x-1/2 flex h-20 w-20 items-center justify-center rounded-full border-4 border-white bg-white/15 backdrop-blur-md shadow-[0_8px_30px_rgba(0,0,0,0.5)] transition active:scale-95 hover:bg-white/25"
          >
